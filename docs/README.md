...
| 22 | v0.6.2 | [v0.6.2-milestone](22-v0.6.2-milestone.md) | TBD (planning) | Mobile + desktop UI pass, iOS Safari audio fix (silent on v0.6.1 smoke), and replay-cost-footer bug |
